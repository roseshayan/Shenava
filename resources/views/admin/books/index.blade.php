...
@section('content')
<h1 class="text-3xl font-bold mb-6">لیست کتاب‌ها</h1>
<a href="{{ route('books.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded mb-4 inline-block">کتاب جدید</a>
...
<a href="{{ route('books.edit', $book->id) }}" class="bg-yellow-400 hover:bg-yellow-500 px-3 py-1 rounded">ویرایش</a>
